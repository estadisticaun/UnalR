...
#' @param varPrincipal Una variable categórica dentro del data frame ingresado en
#'   `datos`.
...
#'   `varPrincipal`. Si no se introduce algún vector se usará la paleta `rainbow`
#'   por defecto.
...
#'
#' @examples
#' if (require("dplyr") && require("RColorBrewer")) {
